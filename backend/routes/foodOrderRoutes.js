...
const {getAllFoodOrders,getFoodOrderByTable,getFoodOrderByChef,getFoodOrderByWaiter,setFoodOrder,updateOrderDone,updateOrderServe,deleteOrderByTable,deleteAllOrders} = require('../controllers/foodOrderControllers');
